...
void addBody(std::vector<sf::RectangleShape> &snake) {
  snake.push_back(sf::RectangleShape(sf::Vector2f(WIDTH / 10, HEIGHT / 10)));
...
int main() {
  ...
  std::unique_ptr<sf::RectangleShape> food = std::make_unique<sf::RectangleShape>(sf::Vector2f(WIDTH / 10, HEIGHT / 10));
